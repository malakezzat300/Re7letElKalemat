...
class RearrangeWordGameFragment : Fragment(), WordsContract.View {
    ...
    override fun showSuccess() {
        Toast.makeText(requireContext(), getString(R.string.right_answer), Toast.LENGTH_SHORT).show()
    }

    override fun showFail() {
        Toast.makeText(requireContext(), getString(R.string.worng_answer), Toast.LENGTH_SHORT).show()
    }
    override fun check() {
    ...
    fun set_data(){
        ...
        for (i in data) {
            if (chosed.contains(i)) {
                val b2 = Button(this@RearrangeWordGameFragment.activity).apply {
                    text = i
                    tag = i
                    ...
                    setOnClickListener {
                        ...
                        val test = Button(this@RearrangeWordGameFragment.activity).apply {
                            text = i
                ...
                val btn = Button(this@RearrangeWordGameFragment.activity).apply {
                    if (chosed.contains(i)) {
                        isEnabled = false
                    } else {
                        isEnabled = true
