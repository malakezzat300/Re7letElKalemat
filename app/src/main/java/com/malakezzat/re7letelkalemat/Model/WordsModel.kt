...
val sentences = listOf(
    ...
    "التَّعَاوُنُ يُسَاهِمُ فِي تَحْقِيقِ النَّجَاحِ.",
    "تَعَلَّمْتُ كَلِمَةً جَدِيدَةً فِي اَلدَّرْسِ اَلْيَوْمِ.",
    "إِذَا كَانَتْ لَدَيْكَ كَلِمَةٌ فَاسْتَخْدِمْهَا بِحِكْمَةٍ.",
    ...
    "اَلتَّحَدِّي يُسَاعِدُكَ عَلَى تَحْسِينِ مَهَارَاتِكَ.",
    "كُلَّ تَحَدِّي يُوَاجِهُهُ اَلْإِنْسَانُ يَجْعَلُهُ أَقْوَى.",
    "اَلتَّعَلُّمُ عَمَلِيَّةٌ مُسْتَمِرَّةٌ لَا تَنْتَهِي.",
    "اَلتَّعَلُّمُ مِنْ اَلْأَخْطَاءِ يُعَزِّزُ اَلْخِبْرَاتِ.",
    "اَلْمُعَلِّمُ اَلْجَيِّدُ يَعْرِفُ كَيْفَ يُحَفِّزُ طُلَّابَهُ.",
    "يَجِبُ أَنْ يَكُونَ اَلْمُعَلِّمُ صَبُورًا وَمُتَفَهِّمًا.",
    "اَلْمُغَامَرَةُ تَتَطَلَّبُ شَجَاعَةً وَثِقَةً بِالنَّفْسِ.",
    "اَلْمُغَامَرَةُ تَجْعَلُ اَلْحَيَاةَ مُمْتِعَةً.",
    "اَلتَّارِيخُ يَرْوِي أَحْدَاثَ اَلْمَاضِي.",
    "كُلُّ بَلَدٍ لَهُ تَارِيخُهُ اَلْخَاصُّ."
)
